...
:export
    ...
    ::    cd ..\..\..
    ::)
    cd versions\fabric\1.21.9 && packwiz mr export
    cd ..\..\..
    ::for /R versions\fabric %%f in (*.mrpack) do move "%%f" build\fabric\
    move versions\fabric\1.21.9\*.mrpack build\fabric
    goto :EOF
...
:update
    ...
    ::    cd ..\..\..
    ::)
    cd versions\fabric\1.21.9 && packwiz update --all
    goto :EOF
...
:update-loader
    ...
    ::    cd ..\..\..
    ::)
    cd versions\fabric\1.21.9 && packwiz migrate loader latest
    goto :EOF
...
:add
    ...
    ::    cd ..\..\..
    ::)
    cd versions\fabric\1.21.9 && packwiz mr add "%2"
    goto :EOF
