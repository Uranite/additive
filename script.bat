...
:export
	...
	::    cd ..\..\..
	::)
	cd archived\fabric\1.18.2 && pw mr export
	cd ..\..\..
...
:update
	...
	::    cd ..\..\..
	::)
	cd archived\fabric\1.18.2 && pw update --all
	goto end
...
:update-loader
	...
	::    cd ..\..\..
	::)
	cd archived\fabric\1.18.2 && pw migrate loader latest
	goto end
...
:refresh
	...
	::    cd ..\..\..
	::)
	cd archived\fabric\1.18.2 && pw refresh
	goto end
